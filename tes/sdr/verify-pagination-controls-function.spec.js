...
test('test', async ({ page }) => {
  ...
  await expect(page.getByRole('main')).toContainText('1of3');
  await page.getByTestId('button').nth(2).click();
  await expect(page.getByRole('main')).toContainText('2of3');
  await page.getByTestId('button').nth(2).click();
  await expect(page.getByRole('main')).toContainText('3of3');
});