...
test('test', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Search by owner name or email' }).fill('nonexistent');
  await expect(page.getByRole('main')).toContainText('No Metrics data available');
});