...
test('test', async ({ page }) => {
  ...
  await expect(page.locator('thead')).toContainText('Rank');
  await expect(page.locator('thead')).toContainText('Name');
  await expect(page.locator('thead')).toContainText('Top Score');
  await expect(page.locator('thead')).toContainText('Cue Cards Explored');
});