...
test('test', async ({ page }) => {
  ...
  await expect(page.getByRole('main')).toContainText('Activity Overview0.00PR Flow0Merged PRs0.0PRs/ Developer0.00Commits/ PR');
  await expect(page.getByRole('main')).toContainText('Code Review Quality0%PRs Without Review0.0Comments/ PR');
});