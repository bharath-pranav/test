...
test('test', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Search by deal name, owner' }).fill('lightning');
  await expect(page.locator('tbody')).toContainText('Lightning Health - New Deal - Market Research');
});