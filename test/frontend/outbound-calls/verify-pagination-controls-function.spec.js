...
test('test', async ({ page }) => {
  ...
  await expect(page.getByRole('main')).toContainText('1of50');
  await page.getByTestId('button').nth(2).click();
  await page.getByTestId('button').nth(2).click();
  await expect(page.getByRole('main')).toContainText('3of50');
  await page.getByTestId('button').nth(1).click();
  await expect(page.getByRole('main')).toContainText('2of50');
});