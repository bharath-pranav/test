...
test('test', async ({ page }) => {
  ...
  await expect(page.getByRole('main')).toContainText('Compliance & Data Security Focused | Cue card');
  await expect(page.getByRole('main')).toContainText('Apparel & Fashion or Furniture.json');
});